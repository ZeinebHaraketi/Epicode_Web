...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder04acd = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer74467 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesd8a0c = [
        
    ];

    public function getConnection()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getConnection', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getMetadataFactory', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getExpressionBuilder', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'beginTransaction', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getCache', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getCache();
    }

    public function transactional($func)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'transactional', array('func' => $func), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'wrapInTransaction', array('func' => $func), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'commit', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->commit();
    }

    public function rollback()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'rollback', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getClassMetadata', array('className' => $className), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'createQuery', array('dql' => $dql), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'createNamedQuery', array('name' => $name), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'createQueryBuilder', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'flush', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'clear', array('entityName' => $entityName), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->clear($entityName);
    }

    public function close()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'close', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->close();
    }

    public function persist($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'persist', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'remove', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'refresh', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'detach', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'merge', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getRepository', array('entityName' => $entityName), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'contains', array('entity' => $entity), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getEventManager', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getConfiguration', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'isOpen', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getUnitOfWork', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getProxyFactory', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'initializeObject', array('obj' => $obj), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'getFilters', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'isFiltersStateClean', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'hasFilters', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return $this->valueHolder04acd->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer74467 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder04acd) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder04acd = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder04acd->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__get', ['name' => $name], $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        if (isset(self::$publicPropertiesd8a0c[$name])) {
            return $this->valueHolder04acd->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder04acd;
    ...
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;
    ...
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__isset', array('name' => $name), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;
    ...
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__unset', array('name' => $name), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;
    ...
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__clone', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        $this->valueHolder04acd = clone $this->valueHolder04acd;
    }

    public function __sleep()
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, '__sleep', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        return array('valueHolder04acd');
    }
    ...
    {
        $this->initializer74467 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer74467;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'initializeProxy', array(), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder04acd;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder04acd;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer74467 && ($this->initializer74467->__invoke($valueHolder04acd, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer74467) || 1) && $this->valueHolder04acd = $valueHolder04acd;

        if ($this->valueHolder04acd === $returnValue = $this->valueHolder04acd->paginate($target, $page, $limit, $options)) {
            return $this;
        }
