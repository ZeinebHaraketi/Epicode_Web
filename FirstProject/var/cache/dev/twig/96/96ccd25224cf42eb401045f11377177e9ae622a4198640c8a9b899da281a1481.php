...
class __TwigTemplate_1aaaa92713c060b15995c104d72b66fec2fdfedc67a25c3495818ca40149d17d extends Template
{
    private $source;
    private $macros = [];
...
{% block captcha_widget %}
    {% apply spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endapply %}
{% endblock %}", "@Captcha/captcha.html.twig", "C:\\Users\\WAEL\\Desktop\\3eme\\pidev\\copie\\FirstProject\\vendor\\captcha-com\\symfony-captcha-bundle\\Resources\\views\\captcha.html.twig");
    }
}
