...
class __TwigTemplate_993d98436654ec3152f27154f03b8feae4646dd374206e365f00dca9d546d4f9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t<li class=\"current dropdown\"><a href=\"#\">Produits</a>
\t\t\t\t\t\t\t\t\t<ul>
...
\t\t\t\t<div class=\"pull-left\"> 
\t\t\t\t\t<h2>Produits</h2>
\t\t\t\t\t<div class=\"text\">List Produits.</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"pull-right\">
...
\t\t</div>
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["produits"]) || array_key_exists("produits", $context) ? $context["produits"] : (function () { throw new RuntimeError('Variable "produits" does not exist.', 275, $this->source); })()));
...
\t\t  <img class=\"img-thumbnail\" width=\"500\" height=\"500\" src=\"";
            // line 282
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["produit"], "photo", [], "any", false, false, false, 282))), "html", null, true);
            echo "\" alt=\"Card image cap\">
\t\t  <div class=\"col-sm\">
\t\t\t  <h5 class=\"card-title\">";
            // line 284
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "nomP", [], "any", false, false, false, 284), "html", null, true);
            echo "</h5>
\t\t\t  <p class=\"card-text\">";
            // line 285
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "prix", [], "any", false, false, false, 285), "html", null, true);
            echo "</p>
\t\t\t  <p class=\"card-text\">";
            // line 286
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "categories", [], "any", false, false, false, 286), "html", null, true);
            echo "</p>


\t\t\t  <a href=\"/panier/new/";
            // line 289
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "idP", [], "any", false, false, false, 289), "html", null, true);
            echo "\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-shopping-cart\"></span></a>
\t\t  </div>
\t  </div>
  </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/626159aa7b967b11798bd1bb/1g164ch1d';
s1.charset='UTF-8';
...
";
    ...
    {
        return array (  800 => 561,  793 => 557,  789 => 556,  785 => 555,  781 => 554,  777 => 553,  773 => 552,  769 => 551,  765 => 550,  761 => 549,  757 => 548,  753 => 547,  749 => 546,  745 => 545,  741 => 544,  736 => 542,  732 => 540,  722 => 539,  707 => 27,  701 => 24,  695 => 21,  691 => 20,  686 => 18,  681 => 15,  671 => 14,  660 => 11,  650 => 10,  635 => 564,  633 => 539,  420 => 329,  396 => 308,  392 => 307,  378 => 295,  366 => 289,  360 => 286,  356 => 285,  352 => 284,  347 => 282,  339 => 276,  335 => 275,  268 => 211,  87 => 32,  85 => 14,  81 => 12,  79 => 10,  71 => 4,  61 => 3,  38 => 1,);
    }
...
\t\t  <img class=\"img-thumbnail\" width=\"500\" height=\"500\" src=\"{{asset('uploads/'~produit.photo)}}\" alt=\"Card image cap\">
\t\t  <div class=\"col-sm\">
\t\t\t  <h5 class=\"card-title\">{{ produit.nomP }}</h5>
\t\t\t  <p class=\"card-text\">{{ produit.prix }}</p>
\t\t\t  <p class=\"card-text\">{{ produit.categories }}</p>


\t\t\t  <a href=\"/panier/new/{{ produit.idP }}\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-shopping-cart\"></span></a>
\t\t  </div>
\t  </div>
  </div>
...
{% endblock %}", "produit/affiche.html.twig", "C:\\COPIE PIDEV SYMFONY\\Trie + Recherche Ajax + Front modifié\\FirstProject\\templates\\produit\\affiche.html.twig");
    }
}
