...
class __TwigTemplate_4807c6bf2e41e838025841ef4acdefcec7728c3a236afced3778bb14fc74552d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_6"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "C:\\COPIE PIDEV SYMFONY\\Trie + Recherche Ajax + Front modifié\\FirstProject\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
