...
class __TwigTemplate_a5c8f6e7a5ca35119d59bd667b7199bed9a7a0efa5bd9e838912f751512b3add extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{#
<form method=\"post\" action=\"{{ path('app_panier_delete', {'idPa': panier.idPa}) }}\"
      onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ panier.idPa) }}\">
    <button class=\"btn\">Delete</button>
</form>
 #}", "panier/_delete_form.html.twig", "C:\\COPIE PIDEV SYMFONY\\Trie + Recherche Ajax + Front modifié\\FirstProject\\templates\\panier\\_delete_form.html.twig");
    }
}
